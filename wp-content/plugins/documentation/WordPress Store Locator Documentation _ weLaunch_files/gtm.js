...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_customParams":["list",["map","key","ecomm_prodid","value",["macro",2]],["map","key","ecomm_pagetype","value",["macro",3]],["map","key","ecomm_totalvalue","value",["template","{{",["macro",4]]]],
      "vtp_conversionId":"955379938",
      ...
      "vtp_conversionId":"955379938",
      "vtp_conversionLabel":"DX1kCIPCitgBEOLhx8cD",
      "vtp_rdp":false,
      "vtp_url":["macro",5],
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\"\u003Ewindow.$crisp=[];window.CRISP_WEBSITE_ID=\"3b578c3d-4707-4180-bc36-b588254d81bd\";(function(){d=document;s=d.createElement(\"script\");s.src=\"https:\/\/client.crisp.chat\/l.js\";s.async=1;d.getElementsByTagName(\"head\")[0].appendChild(s)})();\u003C\/script\u003E",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"2105798953065833\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=2105798953065833\u0026amp;ev=PageView\u0026amp;noscript=1\"\u003E\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",0],
      "arg1":"gtm4wp.productClickEEC|gtm4wp.addProductToCartEEC|gtm4wp.removeFromCartEEC|gtm4wp.checkoutOptionEEC|gtm4wp.checkoutStepEEC|gtm4wp.changeDetailViewEEC"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm4wp.productImpressionEEC"
    },{
      "function":"_cn",
      "arg0":["macro",7],
...
function(z){for(var D=0,F;F=this[D];D++)if(F.tagName===z)return!0;return!1};var v=function(z){z&&"startTag"===z.type&&(z.Gb=q.test(z.tagName)||z.Gb);return z},y=t,x=function(){k="</"+w.pop().tagName+">"+k},A={startTag:function(z){var D=z.tagName;"TR"===D.toUpperCase()&&w.Xc("TABLE")?(k="<TBODY>"+k,B()):l.Uh&&u.test(D)&&w.cg(D)?w.Xc(D)?x():(k="</"+z.tagName+">"+k,B()):z.Gb||w.push(z)},endTag:function(z){w.Je()?l.og&&!w.Xc(z.tagName)?x():w.pop():l.og&&(y(),B())}},B=function(){var z=k,D=v(y());k=z;if(D&&
A[D.type])A[D.type](D)};t=function(){B();return v(y())}}();return{append:function(q){k+=q},jh:t,$h:function(q){for(var u;(u=t())&&(!q[u.type]||!1!==q[u.type](u)););},clear:function(){var q=k;k="";return q},ai:function(){return k},stack:[]}}var b=function(){var k={},l=this.document.createElement("div");l.innerHTML="<P><I></P></I>";k.ei="<P><I></P></I>"!==l.innerHTML;l.innerHTML="<P><i><P></P></i></P>";k.di=2===l.childNodes.length;return k}(),c=/^<([\-A-Za-z0-9_]+)((?:\s+[\w\-]+(?:\s*=?\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
...
" "+r+'="'+(t?t.replace(/(^|[^\\])"/g,'$1\\"'):"")+'"'}return m+(n.Gb?"/>":">")},chars:function(n){return n.text}};return l[k.type](k)};a.i=function(k){var l={},n;for(n in k){var m=k[n];l[n]=m&&m.replace(/(^|[^\\])"/g,'$1\\"')}return l};for(var h in b)a.h=a.h||!b[h]&&h;hc=a})();(function(){function a(){}function b(r){return void 0!==r&&null!==r}function c(r,t,q){var u,w=r&&r.length||0;for(u=0;u<w;u++)t.call(q,r[u],u)}function d(r,t,q){for(var u in r)r.hasOwnProperty(u)&&t.call(q,u,r[u])}function e(r,
t){d(t,function(q,u){r[q]=u});return r}function f(r,t){r=r||{};d(t,function(q,u){b(r[q])||(r[q]=u)});return r}function h(r){try{return n.call(r)}catch(q){var t=[];c(r,function(u){t.push(u)});return t}}var k={Jf:a,Kf:a,Lf:a,Mf:a,Tf:a,Uf:function(r){return r},done:a,error:function(r){throw r;},mh:!1},l=this;if(!l.postscribe){var n=Array.prototype.slice,m=function(){function r(q,u,w){var v="data-ps-"+u;if(2===arguments.length){var y=q.getAttribute(v);return b(y)?String(y):y}b(w)&&""!==w?q.setAttribute(v,
w):q.removeAttribute(v)}function t(q,u){var w=q.ownerDocument;e(this,{root:q,options:u,Hb:w.defaultView||w.parentWindow,Sa:w,nc:hc("",{Sf:!0}),Jc:[q],hd:"",jd:w.createElement(q.nodeName),Db:[],Ia:[]});r(this.jd,"proxyof",0)}t.prototype.write=function(){[].push.apply(this.Ia,arguments);for(var q;!this.Zb&&this.Ia.length;)q=this.Ia.shift(),"function"===typeof q?this.Zf(q):this.xd(q)};t.prototype.Zf=function(q){var u={type:"function",value:q.name||q.toString()};this.dd(u);q.call(this.Hb,this.Sa);this.Ne(u)};
t.prototype.xd=function(q){this.nc.append(q);for(var u,w=[],v,y;(u=this.nc.jh())&&!(v=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("script"):!1)&&!(y=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("style"):!1);)w.push(u);this.Dh(w);v&&this.yg(u);y&&this.zg(u)};t.prototype.Dh=function(q){var u=this.Wf(q);u.pe&&(u.Tc=this.hd+u.pe,this.hd+=u.fh,this.jd.innerHTML=u.Tc,this.Ah())};t.prototype.Wf=function(q){var u=this.Jc.length,w=[],v=[],y=[];c(q,function(x){w.push(x.text);if(x.S){if(!/^noscript$/i.test(x.tagName)){var A=
u++;v.push(x.text.replace(/(\/?>)/," data-ps-id="+A+" $1"));"ps-script"!==x.S.id&&"ps-style"!==x.S.id&&y.push("atomicTag"===x.type?"":"<"+x.tagName+" data-ps-proxyof="+A+(x.Gb?" />":">"))}}else v.push(x.text),y.push("endTag"===x.type?x.text:"")});return{fi:q,raw:w.join(""),pe:v.join(""),fh:y.join("")}};t.prototype.Ah=function(){for(var q,u=[this.jd];b(q=u.shift());){var w=1===q.nodeType;if(!w||!r(q,"proxyof")){w&&(this.Jc[r(q,"id")]=q,r(q,"id",null));var v=q.parentNode&&r(q.parentNode,"proxyof");
v&&this.Jc[v].appendChild(q)}u.unshift.apply(u,h(q.childNodes))}};t.prototype.yg=function(q){var u=this.nc.clear();u&&this.Ia.unshift(u);q.src=q.S.src||q.S.Nh;q.src&&this.Db.length?this.Zb=q:this.dd(q);var w=this;this.Ch(q,function(){w.Ne(q)})};t.prototype.zg=function(q){var u=this.nc.clear();u&&this.Ia.unshift(u);q.type=q.S.type||q.S.TYPE||"text/css";this.Eh(q);u&&this.write()};t.prototype.Eh=function(q){var u=this.Yf(q);this.Cg(u);q.content&&(u.styleSheet&&!u.sheet?u.styleSheet.cssText=q.content:
u.appendChild(this.Sa.createTextNode(q.content)))};t.prototype.Yf=function(q){var u=this.Sa.createElement(q.tagName);u.setAttribute("type",q.type);d(q.S,function(w,v){u.setAttribute(w,v)});return u};t.prototype.Cg=function(q){this.xd('<span id="ps-style"/>');var u=this.Sa.getElementById("ps-style");u.parentNode.replaceChild(q,u)};t.prototype.dd=function(q){q.Wg=this.Ia;this.Ia=[];this.Db.unshift(q)};t.prototype.Ne=function(q){q!==this.Db[0]?this.options.error({message:"Bad script nesting or script finished twice"}):
(this.Db.shift(),this.write.apply(this,q.Wg),!this.Db.length&&this.Zb&&(this.dd(this.Zb),this.Zb=null))};t.prototype.Ch=function(q,u){var w=this.Xf(q),v=this.sh(w),y=this.options.Jf;q.src&&(w.src=q.src,this.qh(w,v?y:function(){u();y()}));try{this.Bg(w),q.src&&!v||u()}catch(x){this.options.error(x),u()}};t.prototype.Xf=function(q){var u=this.Sa.createElement(q.tagName);d(q.S,function(w,v){u.setAttribute(w,v)});q.content&&(u.text=q.content);return u};t.prototype.Bg=function(q){this.xd('<span id="ps-script"/>');
var u=this.Sa.getElementById("ps-script");u.parentNode.replaceChild(q,u)};t.prototype.qh=function(q,u){function w(){q=q.onload=q.onreadystatechange=q.onerror=null}var v=this.options.error;e(q,{onload:function(){w();u()},onreadystatechange:function(){/^(loaded|complete)$/.test(q.readyState)&&(w(),u())},onerror:function(){var y={message:"remote script failed "+q.src};w();v(y);u()}})};t.prototype.sh=function(q){return!/^script$/i.test(q.nodeName)||!!(this.options.mh&&q.src&&q.hasAttribute("async"))};
return t}();l.postscribe=function(){function r(){var v=u.shift(),y;v&&(y=v[v.length-1],y.Kf(),v.stream=t.apply(null,v),y.Lf())}function t(v,y,x){function A(F){F=x.Uf(F);w.write(F);x.Mf(F)}w=new m(v,x);w.id=q++;w.name=x.name||w.id;var B=v.ownerDocument,z={close:B.close,open:B.open,write:B.write,writeln:B.writeln};e(B,{close:a,open:a,write:function(){return A(h(arguments).join(""))},writeln:function(){return A(h(arguments).join("")+"\n")}});var D=w.Hb.onerror||a;w.Hb.onerror=function(F,L,O){x.error({Yh:F+
" - "+L+":"+O});D.apply(w.Hb,arguments)};w.write(y,function(){e(B,z);w.Hb.onerror=D;x.done();w=null;r()});return w}var q=0,u=[],w=null;return e(function(v,y,x){"function"===typeof x&&(x={done:x});x=f(x,k);v=/^#/.test(v)?l.document.getElementById(v.substr(1)):v.Wh?v[0]:v;var A=[v,y,x];v.$g={cancel:function(){A.stream?A.stream.abort():A[1]=a}};x.Tf(A);u.push(A);w||r();return v.$g},{streams:{},Zh:u,Ph:m})}();ic=l.postscribe}})();var E={cb:"_ee",Hc:"_syn",Oh:"_uei",Lh:"_pci",Dc:"event_callback",Mb:"event_timeout",ca:"gtag.config",da:"allow_ad_personalization_signals",Ec:"restricted_data_processing",$a:"allow_google_signals",fa:"cookie_expires",Lb:"cookie_update",ab:"session_duration",la:"user_properties",za:"transport_url",O:"ads_data_redaction",m:"ad_storage",J:"analytics_storage",af:"region",bf:"wait_for_update"};E.xe=[E.da,E.$a,E.Lb];
...
return null},xd=!1;if(H.querySelectorAll)try{var yd=H.querySelectorAll(":root");yd&&1==yd.length&&yd[0]==H.documentElement&&(xd=!0)}catch(a){}var rd=xd;var Md={},K=null,Nd=Math.random();Md.C="GTM-NL28V94";Md.Rb="8c0";Md.Jh="";var Od={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Pd="www.googletagmanager.com/gtm.js";
...
var n=Ei();(l.google_additional_params=l.google_additional_params||{}).gdpr_consent=n;f(l)||c()}else c()},e=function(){U(b,d,c)};hd()?qd(function(){od(E.m)?e():kd(e,E.m)},[E.m]):(mh(),e())})}();
...
var na=function(yo,Ek,zo){if(!Sa(Ek))return!1;for(var vd=Ia(Object(Ek),zo,[]),Kg=0;vd&&Kg<vd.length;Kg++)D(yo,vd[Kg]);return!!vd&&0<vd.length},R;if(m.vtp_useEcommerceDataLayer){var nb=!1;nb||(R=Hl("ecommerce",1))}else m.vtp_ecommerceMacroData&&(R=m.vtp_ecommerceMacroData.ecommerce);if(!Sa(R))return;R=Object(R);var wd=Ia(x,"currencyCode",R.currencyCode);
void 0!==wd&&D("set","&cu",wd);na("ec:addImpression",R,"impressions");if(na("ec:addPromo",R[R.promoClick?"promoClick":"promoView"],"promotions")&&R.promoClick){D("ec:setAction","promo_click",R.promoClick.actionField);return}for(var dc="detail checkout checkout_option click add remove purchase refund".split(" "),ec="refund purchase remove checkout checkout_option add click detail".split(" "),db=0;db<dc.length;db++){var ob=R[dc[db]];if(ob){na("ec:addProduct",ob,"products");D("ec:setAction",dc[db],ob.actionField);
if(ne)for(var Db=0;Db<ec.length;Db++){var Ec=R[ec[Db]];if(Ec){Ec!==ob&&mc(13);break}}break}}},P={name:z};k(x,P,!0);var Y=m.vtp_trackingId||t.trackingId;A("create",Y,P);D("set","&gtm",bi(!0));hd()&&(D("set","&gcs",pd()),a(Y,m));x._x_19&&(null==Ic&&delete x._x_19,
...
google_conversion_value:k.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:k.vtp_gtmOnSuccess,gtm_onFailure:k.vtp_gtmOnFailure,google_gtm:bi()};k.vtp_rdp&&(m.google_restricted_data_processing=!0);void 0!=Hl(E.O)&&!1!==Hl(E.O)&&(m.google_gtm_url_processor=function(v){return v=Pg(v)});var r=function(v){return function(y,x,A){var B="DATA_LAYER"==v?Hl(A):k[x];B&&(m[y]=B)}},t=r("JSON");t("google_conversion_currency","vtp_currencyCode");t("google_conversion_order_id","vtp_orderId");k.vtp_enableProductReporting&&
...
k.vtp_conversionCookiePrefix),m.google_read_gcl_cookie_opt_out=!1):m.google_read_gcl_cookie_opt_out=!0;"1"===Kf(!1)._up&&q("gtm_up","1");l();(function(){hd()?qd(function(){l();var v=od(E.m),y=!v&&void 0!=Hl(E.O)&&!1!==Hl(E.O);!k.vtp_transportUrl&&y&&(m.google_transport_url="https://pagead2.googlesyndication.com/");q("gcs",pd());n(v);v||kd(function(){l();m=C(m);!k.vtp_transportUrl&&m.google_transport_url&&delete m.google_transport_url;q("gcs",pd());q("gcu","1");n(!0)},E.m)},[E.m]):n(!0)})();a||(a=
