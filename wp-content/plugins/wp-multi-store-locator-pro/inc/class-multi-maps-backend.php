      ...
      $url=STORE_LOCATOR_PLUGIN_URL.'assets/img/';
            ...
            <?php 
             ...
             <div class="<?php echo $class; ?>">
              <img src="<?php echo $marker1; ?>" width="50px" height="50px">
                <input type="hidden" value="<?php echo ($class=='wpmsl_custom_marker') ? esc_attr($marker1) : ''; ?>" name="cat_marker_custom" />
		...
		public function update_category_image( $term, $taxonomy){
          ...
          ?>
           ...
           <td>
             ...
             <div class="store_locator_map_settings">
          <p>
              <label title="Choose the color of user marker" for="store_locator_map_type"><?php echo esc_html__("User Marker", 'store_locator'); ?>:</label>
          </p>
          <ul class="default_markers">
              <li>
                  <img src= "<?php echo esc_url($url.'blue.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id == $url.'blue.png') ? 'checked':''; ?> type="radio" value="blue.png" name="catImage" />
              </li>
              <li>
                  <img src= "<?php echo esc_url($url.'red.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id == $url.'red.png') ? 'checked':''; ?> type="radio" value="red.png" name="catImage" />
              </li>
              <li>
                  <img src= "<?php echo esc_url($url.'green.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id == $url.'green.png') ? 'checked':''; ?> type="radio" value="green.png" name="catImage" />
              </li>
              <li>
                  <img src= "<?php echo esc_url($url.'orange.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id == $url.'orange.png') ? 'checked':''; ?> type="radio" value="orange.png" name="catImage" />
              </li>
              <li>
                  <img src= "<?php echo esc_url($url.'purple.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id == $url.'purple.png') ? 'checked':''; ?> type="radio" value="purple.png" name="catImage" />
              </li>
              <li>
                  <img src= "<?php echo esc_url($url.'yellow.png'); ?>" />
                  <input <?php echo (isset($image_id) && $image_id== $url.'yellow.png')?'checked':''; ?> type="radio" value="yellow.png" name="catImage" />
              </li>

          </ul>
          <p>
            <?php esc_html_e('or add custom marker url','store_locator');?>
            <?php $cat_marker_custom=get_term_meta( $term -> term_id,'catImage',true);
        ...
        public function updated_category_image ( $term_id, $tt_id ) {
           ...
           if( isset( $_POST['catImage'] ) && '' !== $_POST['catImage'] ){
             ...
             $is_already_updated=update_term_meta ( $term_id, 'catImage', $image );
           } else {
             update_term_meta ( $term_id, 'catImage', '' );
           }
           if(isset($_POST['cat_marker_custom']) && ''!==$_POST['cat_marker_custom'] && $is_already_updated !== true){
                update_term_meta ( $term_id, 'catImage', $_POST['cat_marker_custom']);
           }
        }
