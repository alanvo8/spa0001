...
class WP_Multi_Store_Locator_Settings{
    ...
    public function init_tabs($tabs=array()){
        ...
        $html .= '<a class="nav-tab '.esc_attr($class). '" href="edit.php?post_type=store_locator&page=store_locator_settings_page&tab='.esc_attr($tab).'">' . $name . '</a>';
        }
        $html .= '</h2>';
        echo $html;
    ...
    public function map_settings(){
        ...
        }else if(isset($_POST['reset-map-settings'])){
            update_option('store_locator_map',  array ( 'enable' => 1, 'width' => 100, 'widthunit' => '%', 'height' => 550,
            'heightunit' => 'PX', 'type' => 'Roadmap', 'unit' => 'mile','fit_screen'=> 1, 'radius' => '5,10,[25],50,100,200,500', 'reset_map' =>1,
                        ...
                        <div class="inside store_locator_map_settings">
                            ...
                            <tr>
                                ...
                                <select name="store_locator_map[widthunit]" id="store_locator_map_widthunit" >
                                    <option <?php  ($map_options['widthunit'] == 'px') ?"selected=": ""; ?> selected value="px"><?php esc_html_e('PX','store_locator'); ?></option>
                            ...
                            <tr>
                                <td><label title="<?php esc_html_e('Select Map Height pixels. Min height 500px','store_locator'); ?>" for="store_locator_map_height"><?php esc_html_e("Map Height ", 'store_locator'); ?>:</label></td>
                                ...
                                <select name="store_locator_map[heightunit]" id="store_locator_map_heightunit" >
                                    <option <?php  echo ($map_options['heightunit'] == 'px') ?"selected=": ""; ?>  value="px"><?php esc_html_e('PX','store_locator'); ?></option>           
                                    <?php /* <option <?php  ($map_options['heightunit'] == '%') ?"selected=": ""; ?> value="px">% in future</option> */?>
                                </select></td>
                            </tr>
                            <tr>
                                <td><label title="Select Map Type" for="store_locator_map_type"><?php esc_html_e("Map Type", 'store_locator'); ?>:</label></td>
                            ...
                            <select name="store_locator_map[direction]" id="store_locator_direction">
                                <option <?php echo (!empty($map_options['direction']) && $map_options['direction'] == 'detail') ? "selected" : ""; ?> value="detail"><?php esc_html_e("On map detailed direction","store_locator") ?></option>
                                <option <?php echo (!empty($map_options['direction']) && $map_options['direction'] == 'gmap') ?"selected" : ""; ?> value="gmap"><?php esc_html_e("Redirect to Google maps","store_locator") ?></option>
                            </select>
                             </td></tr>
                            <tr>
                                <td><label title="Choose the unit of search km/mile" for="store_locator_map_unit"><?php esc_html_e("Search Unit", 'store_locator'); ?>:</label></td>
                                <td><select name="store_locator_map[unit]" id="store_locator_map_unit">
                                    <option <?php echo ($map_options['unit'] == 'km') ?"selected=": ""; ?> value="km"><?php esc_html_e('Km','store_locator'); ?></option>
                                    <option <?php echo ($map_options['unit'] == 'mile') ?"selected=": ""; ?> value="mile"><?php esc_html_e('Mile','store_locator'); ?></option>
                                </select></td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input <?php echo (isset($map_options['fit_screen']) && ($map_options['fit_screen'])==1)?'checked':''; ?> value="1" type="checkbox" id="store_locator_fit_screen" name="store_locator_map[fit_screen]" >
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td><label title="Choose search options here. the default one will be between square brakets" for="store_locator_map_radius"><?php esc_html_e("Search radius options", 'store_locator'); ?>:</label></td>
                            ...
                            <tr>
                               <td> <label title="Enable disable clusters on map" for="store_locator_map_cluster"><?php esc_html_e("Show Map Cluster", 'store_locator'); ?>?</label></td>
                            ...
                            <tr>
                                <td><label title="Enable/Disable zoom by scroll on map" for="store_locator_map_scroll"><?php esc_html_e('Zoom by scroll on map1', 'store_locator'); ?>?</label></td>
                            ...
                            <tr>
                                <td><label title="Check to hide Points of Interest in 'Standard Map'" for="store_locator_map_mappoi"><?php esc_html_e('Hide POI (Points of Interest)', 'store_locator'); ?>?</label></td>
                                <td><input value="0" type="hidden" name="store_locator_map[mappoi]" >
                                <input <?php echo ($map_options['mappoi'])?'checked':''; ?> value="1" type="checkbox" id="store_locator_map_mappoi" name="store_locator_map[mappoi]" ></td>
                            </tr>
                            <tr>
                                <td><label title="<?php esc_html_e('Display default Map Search','store_locator'); ?>" for="store_locator_default_search"><?php esc_html_e('Show Map Search options', 'store_locator'); ?></label></td>
                            ...
                            <tr>
                                ...
                                <td><ul class="hide_fields">
                                    ...
                                    <li>
                                    <input <?php echo (isset($map_options['search_field_location']))?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_location" name="store_locator_map[search_field_location]" ><?php esc_html_e('Location Field','store_locator');?>
                                    </li>
                                    <li><input <?php echo (isset($map_options['search_field_radius']))?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_radius" name="store_locator_map[search_field_radius]" ><?php esc_html_e('Radius Field','wpmsl');?></li>
                                    <li><input <?php echo (isset($map_options['category']))?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_category" name="store_locator_map[category]" ><?php esc_html_e('Category Field','store_locator');?></li>
                                    <li><input <?php echo (isset($map_options['tag']))?'checked':''; ?> value="hide-field" type="checkbox" id="search_field_tag" name="store_locator_map[tag]" ><?php esc_html_e('Tags Field','store_locator');?></li>
                            ...
                            <tr>
                                <td><label title="Map Search Open as Default" for="map_window_open"><?php esc_html_e("Map Search Open as Default", 'store_locator'); ?></label></td>
                            ...
                            ?>
                            <tr>
                                <td colspan="2"><label title="<?php esc_html_e('You can customise the contetnt of the info window here by adding HTML if you need. Also you can use the below variables in the content','store_locator'); ?>" for="store_locator_map_infowindow"><b><?php esc_html_e("Info Window Content", 'store_locator'); ?></b>: <br/><span class="store_locator_tip">placeholders: {image} {address} {city} {state} {country} {zipcode} {name} {phone} {email} {website} {categories} {description} {working_hours}</span></label>
                                <textarea name="store_locator_map[infowindow]" rows="10" id="store_locator_map_infowindow" class="widefat"><?php echo $map_options['infowindow']; ?></textarea></td>
                            </tr>
                            <tr>
                                <td colspan="2"><label title="<?php esc_html_e('You can customize the look of the map by adding styles here','store_locator'); ?>" for="store_locator_map_style"><b><?php esc_html_e("Customised Map Style", 'store_locator'); ?></b>: <span class="store_locator_tip"><?php esc_html_e('You can get some styles from','store_locator');?><a target="_blanck" href="https://snazzymaps.com"> <?php esc_html_e('Snazzy Maps','store_locator');?></a></span> </label>
                                <textarea name="store_locator_map[custom_style]"  rows="10" id="store_locator_map_style" class="widefat"><?php echo stripslashes($map_options['custom_style']); ?></textarea></td>
                            </tr>
                            <tr class="submit">
                                <td colspan="1"><input type="submit" class="button-primary" name="map-settings" value="<?php esc_html_e("Save Changes", 'store_locator'); ?>"></td>
                                <td colspan="1"><button class="button-primary" style="float:right;" id="reset-map-settings" name="reset-map-settings" value="reset-map-settings" onclick="return confirm('Warning! This will replace all your current Map Settings with default ones, press Ok to proceed.');" ><?php esc_html_e("Reset to Default", 'store_locator'); ?></button></td>
                            </tr>
                            </tbody>
                        </table>
                        </div>
        ...
        <form method="POST" >
                    <div class="postbox" >
                        ...
                        <table>
                            ...
                            <td><input type="text" name="get_location_btn_txt" class="regular-text" value="<?php echo !empty($placeholder_setting['get_location_btn_txt']) ? esc_attr($placeholder_setting['get_location_btn_txt']) : ''; ?>"/></td>
                            </tr>
                            <tr><th><?php esc_html_e('Enter Location Text','store_locator');?></th>
                            <td><input type="text" name="enter_location_txt" class="regular-text" value="<?php echo !empty($placeholder_setting['enter_location_txt']) ? esc_attr($placeholder_setting['enter_location_txt']) : ''; ?>" /></td>
                            </tr>
                            <tr><th><?php esc_html_e('Select Category','store_locator');?></th>
                            <td><input type="text" name="select_category_txt" class="regular-text" value="<?php echo !empty($placeholder_setting['select_category_txt']) ? esc_attr($placeholder_setting['select_category_txt']) : ''; ?>"/></td>
                            </tr>
                            <tr><th><?php esc_html_e('Select Tags','store_locator');?></th>
                            <td><input type="text" name="select_tags_txt" class="regular-text" value="<?php echo !empty($placeholder_setting['select_tags_txt']) ? esc_attr($placeholder_setting['select_tags_txt']) : ''; ?>"/></td>
                            </tr>
                            <tr><th><?php esc_html_e('Search Options Button Text','store_locator');?></th>
                            <td><input type="text" name="search_options_btn" class="regular-text" value="<?php echo !empty($placeholder_setting['search_options_btn']) ? esc_attr($placeholder_setting['search_options_btn']) : ''; ?>"/></td>
                            </tr>
                            <!--
                             <tr><th><?php // esc_html_e('Location not found text','store_locator');?></th>
                            <td><input type="text" name="location_not_found" class="regular-text" value="<?php echo !empty($placeholder_setting['location_not_found']) ? esc_attr($placeholder_setting['location_not_found']) : ''; ?>"/></td>
                            </tr>
                            -->
                            <tr><th><?php esc_html_e('Store list text','store_locator');?></th>
                            <td><input type="text" name="store_list" class="regular-text" value="<?php echo !empty($placeholder_setting['store_list']) ? esc_attr($placeholder_setting['store_list']) : '' ;?>"/></td>
                            </tr>
                            <tr><th><?php esc_html_e('Visit Website text','store_locator');?></th>
                            <td><input type="text" name="visit_website" class="regular-text" value="<?php echo !empty($placeholder_setting['visit_website']) ? esc_attr($placeholder_setting['visit_website']) : '' ;?>"/></td>
                            </tr>
                            <tr class="submit">
                            ...
                            <tr><th>
                                ...
                                <select  id="store_locator_single_items" multiple="multiple" class="regular-text">
                                    ...
                                    <?php foreach ($items as $item): ?>
                                        <?php if ($item): ?>
                                            <option value="<?php echo esc_attr($item); ?>" <?php echo (in_array($item, $selectedItems)) ? "selected" : ""; ?>><?php echo $item; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
