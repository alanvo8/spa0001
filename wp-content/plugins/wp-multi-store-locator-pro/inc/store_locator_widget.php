...
class wp_store_locator_nearby_widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                ...
                __('Stor Locator Nearby Stores', 'store_locator'),
                array(
                        'description' => __('Display nearby stores to website visitor', 'store_locator'),
                    )
        );
    }
    ...
    public function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','store_locator'); ?></label> 
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            <label for="<?php echo $this->get_field_id('number_of_stores'); ?>"><?php _e('Number of displayed Stores:','store_locator'); ?></label> 
